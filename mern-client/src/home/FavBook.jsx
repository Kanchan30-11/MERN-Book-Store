    ...
    <div className='px-4 lg:px24 my-20 flex flex-col md:flex-row  justify-between items-center gap-12'>
      ...
      <div className='md:w-1/2 space-y-6'>
         ...
         <p className='mb-10 text-lg md:w-5/6'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. 
          Itaque provident laudantium quos dicta fugiat unde? Autem magni soluta, dolorum tenetur ex reiciendis aperiam, 
          similique harum eveniet velit quidem expedita optio.</p>
          {/* stats */}
