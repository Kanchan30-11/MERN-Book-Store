...
const PromoBanner = () => {
  return (
    <div className='mt-16 pt-6 pb-7 bg-blue-950 px-4 lg:px-24'>
      <div className='flex flex-col md:flex-row justify-between items-center gap-12'>
        <div className='md:w-1/2'>
        <h2 className='text-4xl font-bold mb-6 leading-snug text-white '>2024 National Book Awards for Fiction Shortlist</h2>
